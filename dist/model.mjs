...
export const strategicFit = {low:{label:'Lav',rank:1},medium:{label:'Middels',rank:2},high:{label:'Høy',rank:3}};
const baseExamples = [
 {id:'diagnostics',name:'Proaktiv diagnostikk',description:'Oppdag og løs bredbåndsproblemer før kunden tar kontakt. Prioriter kunder med gjentatte avbrudd.',segment:'Bredbånd · gjentatte feil',customers:100000,reach:80,baseline:10,low:.2,expected:.6,high:1,value:6000,cost:900000,setup:200000,confidence:'quasi',evidence:'Illustrasjon: Et mulig kvasi-eksperiment med sammenlignbare områder før og etter utrulling. Ingen faktisk studie ligger bak tallene. Kontroller parallelle trender, feilmønster og forskjeller i kundemiks.',strategicFit:'high',strategicFitNote:'Illustrativt: Understøtter uttalt prioritet om færre bredbåndsfeil før kunden merker dem. Vurderingen påvirker ikke nettoverdien.'},
 {id:'wifi',name:'Bedre Wi-Fi-opplevelse',description:'Bedre dekning og stabilitet gjennom optimalisering, veiledning og målrettede tiltak i hjemmet.',segment:'Wi-Fi · svak dekning',customers:160000,reach:65,baseline:9,low:.1,expected:.4,high:.8,value:6000,cost:1200000,setup:400000,confidence:'observational',evidence:'Illustrativt observasjonsgrunnlag. Sammenheng mellom Wi-Fi-kvalitet og churn kan skyldes bolig, utstyr, kundemiks og engasjement. Den kausale effekten må testes.',strategicFit:'medium',strategicFitNote:'Illustrativt: Relevant for kundeopplevelsen, men ikke forankret i et navngitt strategisk initiativ ennå.'},
 {id:'parental',name:'Foreldrekontroll',description:'Enklere skjermtidsstyring og tryggere nett for familier med barn.',segment:'Familier · barn i husstanden',customers:75000,reach:35,baseline:7,low:-.1,expected:.25,high:.6,value:5500,cost:450000,setup:100000,confidence:'hypothesis',evidence:'Illustrativ hypotese uten målt churn-effekt. Lavscenarioet inkluderer mulig økt churn. Test behov, aktivering og bruk før en kontrollert utrulling.',strategicFit:'low',strategicFitNote:'Illustrativt: Sidespor fra kjernesatsingen på bredbånd og Wi-Fi-kvalitet. Vurder om dette bør konkurrere med tiltak nærmere strategien.'},
 {id:'adoption',name:'Mitt WiFi-adopsjon',description:'Øk aktiv bruk av Mitt WiFi gjennom onboarding og relevant hjelp i kundereisen.',segment:'App · nye og inaktive brukere',customers:200000,reach:45,baseline:8,low:0,expected:.3,high:.5,value:6000,cost:400000,setup:100000,confidence:'benchmark',evidence:'Illustrativt benchmark, ikke en dokumentert effekt. Mer engasjerte kunder kan både bruke appen og ha lavere churn. Ikke tolk bruker/ikke-bruker-forskjellen som kausal.',strategicFit:'medium',strategicFitNote:'Illustrativt: Støtter appstrategien, men er ikke identifisert som et av årets hovedinitiativ.'}
];
...
export function validateIssue(t){
 ...
 if(!strategicFit[t.strategicFit])return fail('Velg en gyldig strategisk fit.','strategicFit');
